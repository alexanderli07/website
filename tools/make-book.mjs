/**
 * Build AL-1600's opening book from TheFaix's own chess.com games.
 *
 *   node tools/make-book.mjs <dir-of-monthly-pgns>
 *
 * Writes book.js at the repo root. The book is AL-1600's impersonation of Alex:
 ...
 *    leans on. Depth <= 16 plies; a prefix needs >= 3 visits and a move >= 2
 *    plays to survive, which prunes bullet mouse-slips. (Was 4; widened when
 *    Alex asked for more training — deeper into his lines, same games.)
...
const USER = "thefaix";
const MAX_PLIES = 16, MIN_VISITS = 3, MIN_PLAYS = 2;
...
const header = `/* AUTO-GENERATED by tools/make-book.mjs — do not edit by hand; regenerate.
   AL-1600's opening book: TheFaix's own 2025+ chess.com games (the Queen's
